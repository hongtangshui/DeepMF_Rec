...
# encoding=utf-8
'''
calculate time-aware information such as ctr and recency for candidate news.
use these time-info to evaluate quality of the cold start news.
'''
...
def cal_ctr(scale):
    ...
    for key in imp_cnt.keys():
        train_ctr[key] = click_cnt[key] / imp_cnt[key]
